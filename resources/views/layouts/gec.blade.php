                    ...
                    <div class="topbar-settings-dropdown">
                        ...
                        <form method="POST" action="{{ route('gec.settings.semesters') }}">
                            ...
                            <label class="switch-row">
                                ...
                                <span class="switch"><input type="checkbox" name="semester_first_enabled" value="1" @checked($gecDepartment?->semester_first_enabled ?? true)><span class="switch-track"></span></span>
                            </label>
                            <label class="switch-row">
                                <span>2nd Semester</span>
                                <span class="switch"><input type="checkbox" name="semester_second_enabled" value="1" @checked($gecDepartment?->semester_second_enabled ?? true)><span class="switch-track"></span></span>
                            </label>
                            <label class="switch-row">
                                <span>Summer</span>
