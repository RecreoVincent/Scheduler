...
<body class="print-preview">
    ...
    <main class="print-sheet">
        <header class="header">
            ...
            <p>{{ $student->name }} &middot; {{ $student->course }} &middot; Year {{ $student->year_level }}</p>
            <p>{{ $student->academicSection?->name ?? 'Section not assigned' }} &middot; Generated {{ now()->format('F j, Y g:i A') }}</p>
        </header>
