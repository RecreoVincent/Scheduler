...
class ScheduleController extends DeanController
{
    ...
    private function failureGuidance(string $message): string
    {
        return match (true) {
            ...
            str_contains($message, 'coverage section') => 'Only one eligible Year 1 or Year 2 section is selected to cover M–W, T–Th, and F–S. Add the missing Major subjects for that section and make sure instructors and rooms are available on those days.',
