...
class ScheduleArchiveController extends GecController
{
    ...
    public function index(Request $request): View
    {
        ...
        $archiveQuery = ClassSchedule::onlyTrashed()
            ...
            ->whereHas('subject', fn ($q) => $q->where('classification', 'Minor'))
    ...
    public function restore(int $schedule): RedirectResponse
    {
        $schedule = $this->archivedSchedule($schedule);
    ...
    private function archivedSchedule(int $schedule): ClassSchedule
    {
