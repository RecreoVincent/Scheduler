...
class InstructorController extends GecController
{
    public function index(Request $request, InstructorIdGenerator $instructorIds): View
    {
        ...
        return view('gec.instructors.index', compact('course', 'pendingInstructors', 'instructors', 'editingInstructor', 'instructorAccountCount', 'instructorIdPreview'));
    }

    public function create(Request $request, InstructorIdGenerator $instructorIds): View
    {
        return view('gec.instructors.form', [
            'course' => $this->course($request),
            'instructor' => new User,
            'instructorIdPreview' => $instructorIds->preview(),
        ]);
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('gec.instructors.index')->with('success', "Instructor account created successfully. Instructor ID: {$instructor->instructor_id}.");
    }
    ...
    public function edit(Request $request, User $instructor): View
    {
        ...
        return view('gec.instructors.form', ['course' => $this->course($request), 'instructor' => $instructor]);
    }
    ...
    public function update(Request $request, User $instructor): RedirectResponse
    {
        ...
        return redirect()->route('gec.instructors.index')->with('success', 'Instructor account updated successfully.');
    }
    ...
    public function destroyAll(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('gec.instructors.index')->with(
            'success',
