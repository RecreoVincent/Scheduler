...
class InstructorController extends GecController
{
    public function index(Request $request): View
    {
        ...
        return view('gec.instructors.index', compact('course', 'pendingInstructors', 'instructors', 'editingInstructor', 'instructorAccountCount'));
    }

    public function create(Request $request): View
    {
        return view('gec.instructors.form', ['course' => $this->course($request), 'instructor' => new User]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('gec.instructors.index')->with('success', 'Instructor account created successfully.');
    }
